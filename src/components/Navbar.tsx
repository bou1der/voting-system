import { BookUser, Info, TicketSlash, User } from "lucide-react"
        ...
        <span className="flex items-center">
          {
            session ? (
              <>
                <Link href="/voiting"><Button variant="link" className="space-x-2 text-primary-foreground"><TicketSlash/><h3>Голосования</h3></Button></Link>
